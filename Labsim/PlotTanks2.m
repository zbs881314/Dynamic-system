...
persistent ULx ULy URx URy LLx LLy LRx LRy
...
if t == 0
    ...
    % Need to erase text first before putting new text down
    %text(ULx,ULy+100,['Level: ' num2str(h1,3)]);
    %text(URx,URy+100,['Level: ' num2str(h2,3)]);
    %text(LLx,LLy+100,['Level: ' num2str(h3,3)]);
    %text(LRx,LRy+100,['Level: ' num2str(h4,3)]);
